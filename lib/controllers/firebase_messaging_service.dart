...
// import 'package:hadn/constants.dart';
// import 'package:hadn/views/other/booking_details.dart';
// import 'package:hadn/views/other/sp_booking_details.dart';
...
//           onTap: () {
//             if (message.data['msgType'] == '1' && Data.userType == Constants.userTypeHadn) {
//               Data.navigator.navigator.push(MaterialPageRoute(
//                 builder: (context) => SPBookingDetails(bookingId: message.data['msgType'],),
//               ));
//             } else if (message.data['msgType'] == '1' && Data.userType == Constants.userTypeCustomer) {
//               Data.navigator.navigator.push(MaterialPageRoute(
//                 builder: (context) => BookingDetails(bookingId: message.data['msgType'],),
//               ));
//             }
//           },
//           title: (cancelFunc) =>
