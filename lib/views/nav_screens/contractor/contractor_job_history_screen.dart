...
class ContractorJobHistoryScreen extends StatefulWidget {
  ...
  @override
  _ContractorJobHistoryScreenState createState() =>
      _ContractorJobHistoryScreenState();
}

class _ContractorJobHistoryScreenState extends State<ContractorJobHistoryScreen>
  ...
  void _onRefresh() async {
    setState(() {
      _openFuture = ProviderController().getAcceptedJobsByProvider();
      _closedFuture = ProviderController().getAcceptedJobsByProvider(isOpen: 0);
    });
